...
Crafty.scene('Load', function() {
	...
	Crafty.load(assetsObj, function() {
		...
		initMouse(); //Instantiates the mouse
		if(playerID != null) connect(HOST, playerID, NAMEID, LEVEL);
		else console.log("DEBUG> Could not connect to server, invalid Player for JOIN/CREATE");
